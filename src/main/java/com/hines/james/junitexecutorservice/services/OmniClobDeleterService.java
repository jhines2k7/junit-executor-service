...
public class OmniClobDeleterService {
    ...
    public OmniClobDeleterService(ClobDeleterRepositoryService clobDeleterRepositoryService,
                                  ...
                                  OmFavoritesRepository omFavoritesRepository,
                                  OmniMetaDataRepository omniMetaDataRepository) {
    ...
    public void deleteOmniMetaData(AuthoringObsoleteMessage message) {
        ...
        clobDeleterRepositoryService = new ClobDeleterRepositoryService(omFavoritesRepository, omniMetaDataRepository);
